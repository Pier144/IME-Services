...
const styles = {
  article: {
    lead: 'font-body text-17 leading-165 font-light text-ink md:text-20',
    paragraph: 'mt-20 font-body text-15-5 leading-185 font-light text-ink-2 md:text-16-5 md:mt-26',
    ...
    list: 'mt-20 flex flex-col gap-10 font-body text-15-5 leading-170 font-light text-ink-2 md:text-16-5',
    image: 'h-220 md:h-340',
    caption: 'mt-10 font-body text-12 text-ink-3',
  },
  preview: {
    lead: 'font-body text-13-5 leading-170 font-light text-ink-2',
    paragraph: 'mt-12 font-body text-12-5 leading-180 font-light text-ink-3',
    ...
    list: 'mt-12 flex flex-col gap-6 font-body text-12-5 leading-170 font-light text-ink-3',
    image: 'h-110',
