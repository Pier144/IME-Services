...
const en: Dictionary = {
  ...
  admin: {
    ...
    login: {
      ...
      remainingOne: 'One attempt left.',
      remainingNone: 'One more wrong attempt locks access for ten minutes.',
      blocked: 'Too many attempts. Try again in a few minutes.',
      retryAt: 'You can try again at {time}.',
    ...
    news: {
      ...
      emptySearch: 'No article matches “{term}”.',
      emptySearchHint: 'Try fewer words, or',
      emptySearchReset: 'clear the search',
      emptyFilters: 'No article matches these filters.',
      emptyFiltersReset: 'clear the filters',
      emptyArchive: 'There are no articles yet.',
      emptyArchiveText:
        'News appear on the home page and in /news. The first article can stay a draft until it is ready.',
      countNone: 'No articles',
    ...
    editor: {
      ...
      newArticle: 'New article',
      /** Never red: it is not a mistake, it is something still to finish. */
      publishNotice: 'Before publishing, this is missing: {fields}.',
      dismissNotice: 'Dismiss the notice',
      settings: 'Settings',
      settingsTitle: 'SETTINGS',
      closeSettings: 'Close the settings',
      viewPage: 'View the published page',
      smallScreen:
        'This is a narrow screen: you can read and fix typos, but articles are easier to write at a desk.',
      labels: {
        title: 'TITLE',
        category: 'CATEGORY',
      ...
      placeholders: {
        title: 'Article title',
        excerpt: 'Two lines about the article. They appear in listings and shared previews.',
        paragraph: 'Write. The «+» on the left adds a heading, a quote, a list or a photo.',
        paragraphLabel: 'Text',
        heading: 'Section heading',
        headingLabel: 'Section heading',
        quote: 'The line to quote',
        quoteLabel: 'Pull quote',
        attribution: 'Who said it',
        attributionLabel: 'Quote attribution',
        listItem: 'A list entry',
        listItemLabel: 'List entry',
        photoLabel: 'Article photo',
      },
      add: {
        open: 'Add a block below',
        title: 'ADD',
        paragraph: 'Text',
        paragraphHint: 'A normal paragraph',
        heading: 'Section heading',
        headingHint: 'Splits the article into parts',
        quote: 'Pull quote',
        quoteHint: 'With attribution and a gold rule',
        list: 'Bulleted list',
        listHint: 'Gold dashes, one entry per line',
        image: 'Photo',
        imageHint: 'Full-column image with caption',
      },
      photo: {
        field: 'Photo',
        cover: 'upload the cover',
        drop: 'Drag the photo here or',
        limits: 'JPG, PNG, WEBP · up to {size}',
        caption: 'Caption (optional)',
        alt: 'Description for people who cannot see the photo',
        reuse: 'Or a photo already in use',
