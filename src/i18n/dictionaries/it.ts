...
const it = {
  ...
  home: {
    metaTitle:
      'IME Service · luminarie artistiche e impianti elettrici a Verona',
    metaDescription:
    ...
    hero: {
      ...
      slides: [
        ...
        },
        {
          ...
          photo:
            'FOTO SLIDE 3/4: quadro elettrico industriale o cantiere in corso',
        },
        {
          label: 'LA FABBRICA',
    ...
    quote: {
      ...
      successText:
        'Ti rispondiamo entro due giorni lavorativi. Se hai fretta, chiamaci.',
  ...
  custom: {
    metaTitle:
      'Soggetti luminosi personalizzati su disegno | La Fabbrica di Babbo Natale',
    metaDescription:
  ...
  news: {
    ...
    title: 'Dalla Fabbrica',
    intro:
      'Accensioni, nuove collezioni, cantieri e piccole storie di luce dal Veneto.',
    allCategories: 'Tutte',
  ...
  impianti: {
    ...
    sectors: [
      {
        number: '01',
        title: 'Abitazioni e condomini',
        note: 'nuovo · ristrutturazione',
      },
      {
        number: '02',
        title: 'Capannoni e aziende agricole',
        note: 'quadri · forza motrice',
      },
      {
        number: '03',
        title: 'Negozi, hotel e cantine',
        note: 'illuminazione · domotica',
      },
      {
        number: '04',
        title: 'Enti pubblici e manifestazioni',
        note: 'noleggio · sicurezza',
      },
    ],
    aside: {
    ...
    cta: {
      ...
      subtitle:
        'Sopralluogo e preventivo senza impegno, in tutta la provincia di Verona.',
  ...
  careers: {
    ...
    form: {
      ...
      subtitle:
        'Nessuna posizione ti corrisponde? Scrivici comunque: le squadre crescono ogni anno.',
  ...
  forms: {
    ...
    dropzone: {
      ...
      hintAttachment:
        'JPG, PNG, PDF, AI, DWG · max 20 MB · anche una foto dello schizzo a mano',
    ...
    errors: {
      ...
      contactRequired:
        'Lasciaci almeno un’email o un telefono per risponderti.',
  ...
  admin: {
    ...
    editor: {
      ...
      newArticle: 'Nuovo articolo',
      /** Mai rosso: non è un errore di chi scrive, è una cosa da finire. */
      publishNotice: 'Prima di pubblicare manca: {fields}.',
      dismissNotice: 'Chiudi l’avviso',
      settings: 'Impostazioni',
      settingsTitle: 'IMPOSTAZIONI',
      closeSettings: 'Chiudi le impostazioni',
      viewPage: 'Vedi la pagina pubblicata',
      smallScreen:
        'Questo è uno schermo stretto: si legge e si correggono i refusi, ma l’articolo si scrive meglio da una scrivania.',
      labels: {
        title: 'TITOLO',
        category: 'CATEGORIA',
      ...
      placeholders: {
        ...
        excerpt:
          'Due righe che raccontano l’articolo. Compaiono negli elenchi e nelle anteprime condivise.',
        paragraph:
          'Scrivi. Il «+» qui a sinistra aggiunge un titolo di sezione, una citazione, un elenco o una foto.',
        paragraphLabel: 'Testo',
        heading: 'Titolo di sezione',
        headingLabel: 'Titolo di sezione',
        quote: 'La frase da citare',
        quoteLabel: 'Citazione',
        attribution: 'Chi l’ha detta',
        attributionLabel: 'Attribuzione della citazione',
        listItem: 'Una voce dell’elenco',
        listItemLabel: 'Voce dell’elenco',
        photoLabel: 'Foto dell’articolo',
      },
      add: {
        open: 'Aggiungi un blocco qui sotto',
        title: 'AGGIUNGI',
        paragraph: 'Testo',
        paragraphHint: 'Un paragrafo normale',
        heading: 'Titolo di sezione',
        headingHint: 'Divide l’articolo in parti',
        quote: 'Citazione',
        quoteHint: 'Con attribuzione, filetto oro',
        list: 'Elenco puntato',
        listHint: 'Trattini oro, una voce per riga',
        image: 'Foto',
        imageHint: 'Immagine a tutta colonna con didascalia',
      },
      photo: {
        field: 'Foto',
        cover: 'carica la copertina',
        drop: 'Trascina qui la foto oppure',
        limits: 'JPG, PNG, WEBP · massimo {size}',
        caption: 'Didascalia (facoltativa)',
        alt: 'Descrizione per chi non vede la foto',
        reuse: 'Oppure una foto già usata',
